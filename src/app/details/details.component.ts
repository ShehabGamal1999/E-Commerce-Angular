...
export class DetailsComponent {
  ...
  increaseQuantity() {
    if (this.quantity < this.productDetails.stock) {
      this.quantity++;
      this.productDetails.stock--; // Reduce stock when quantity is increased
    }
  }

  // Method to decrease quantity and adjust stock
  decreaseQuantity() {
    if (this.quantity > 1) {
      this.quantity--;
      this.productDetails.stock++; // Increase stock when quantity is decreased
    }
  }
